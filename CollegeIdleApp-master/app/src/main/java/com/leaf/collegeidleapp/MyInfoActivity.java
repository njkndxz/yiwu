...
public class MyInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //从bundle中获取用户账号/学号
        final TextView tvUserNumber = (TextView) findViewById(R.id.tv_stu_number);
        tvUserNumber.setText(this.getIntent().getStringExtra("stu_number1"));
        tvStuName = (TextView) findViewById(R.id.tv_stu_name);
        tvStuMajor = (TextView) findViewById(R.id.tv_stu_major);
        tvStuPhone = (TextView) findViewById(R.id.tv_stu_phone);
        tvStuQq = (TextView) findViewById(R.id.tv_stu_qq);
        tvStuAddress = (TextView) findViewById(R.id.tv_stu_address);
        ...
        Button btnModifyInfo = (Button) findViewById(R.id.btn_modify_info);
        //跳转到修改用户信息界面
