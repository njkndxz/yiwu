...
public class ModifyInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //利用bundle传递学号
        final TextView tvStuNumber = (TextView) findViewById(R.id.tv_stu_number);
        tvStuNumber.setText(this.getIntent().getStringExtra("stu_number2"));
        etStuName = (EditText) findViewById(R.id.et_stu_name);
        etMajor = (EditText) findViewById(R.id.et_stu_major);
        etPhone = (EditText) findViewById(R.id.et_stu_phone);
        etQq = (EditText) findViewById(R.id.et_stu_qq);
        etAddress = (EditText) findViewById(R.id.et_stu_address);
        ...
        Button btnSaveInfo = (Button) findViewById(R.id.btn_save_info);
