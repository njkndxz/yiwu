...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        lvAllCommodity = (ListView) findViewById(R.id.lv_all_commodity);
        ...
        final TextView tvStuNumber = (TextView) findViewById(R.id.tv_student_number);
        String str = "";
        if (bundle != null) {
        ...
        ImageButton IbAddProduct = (ImageButton) findViewById(R.id.ib_add_product);
        //跳转到添加物品界面
        ...
        ImageButton IbPersonalCenter = (ImageButton) findViewById(R.id.ib_personal_center);
        //跳转到个人中心界面
        ...
        //点击不同的类别,显示不同的商品信息
        ibLearning = (ImageButton) findViewById(R.id.ib_learning_use);
        ibElectronic = (ImageButton) findViewById(R.id.ib_electric_product);
        ibDaily = (ImageButton) findViewById(R.id.ib_daily_use);
        ibSports = (ImageButton) findViewById(R.id.ib_sports_good);
