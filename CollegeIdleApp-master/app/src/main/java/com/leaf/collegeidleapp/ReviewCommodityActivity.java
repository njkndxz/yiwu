...
public class ReviewCommodityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivCommodity = (ImageView) findViewById(R.id.iv_commodity);
        ...
        //点击收藏按钮
        ImageButton ibMyLove = (ImageButton) findViewById(R.id.ib_my_love);
        ...
        lvReview = (ListView) findViewById(R.id.list_comment);
        //提交评论点击事件
        Button btnReview = (Button) findViewById(R.id.btn_submit);
