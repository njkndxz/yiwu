...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvStuNumber = (EditText) findViewById(R.id.et_username);
        tvStuPwd = (EditText) findViewById(R.id.et_password);
        tvStuConfirmPwd = (EditText) findViewById(R.id.et_confirm_password);
        //注册点击事件
